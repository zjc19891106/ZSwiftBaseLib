...
public extension ZSwiftLib where Base == String {
    var numCount: Int {
        var count = 0
    ...
    var md5: String? {
        ...
        guard let data = base.data(using: String.Encoding.utf8) else { return nil }
    ...
    func jsonToDictionary() -> Dictionary<String,Any> {
        base.data(using: .utf8)?.z.toDictionary() ?? [:]
    }
    ...
    func deleteEmoij() -> String {
        ...
        return base.z.removeMatchRegular(expression: "[^\\u0020-\\u007E\\u00A0-\\u00BE\\u2E80-\\uA4CF\\uF900-\\uFAFF\\uFE30-\\uFE4F\\uFF00-\\uFFEF\\u0080-\\u009F\\u2000-\\u201f\r\n]", with: "")
    }
    ...
    func convertToTextImage(font: UIFont, textColor: UIColor, size: CGSize) -> UIImage? {
        ...
        let imgWidth = base.z.sizeWithText(font: font, size: size).width
